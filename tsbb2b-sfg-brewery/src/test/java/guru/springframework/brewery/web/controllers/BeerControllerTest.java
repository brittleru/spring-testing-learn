...
//    @Mock
    @MockBean  // insert a mocked object to the BearService
...
//                    .build();
        ...
        // let spring boot do it's autoconfiguration magic

    }

    @AfterEach
    void tearDown() {
        // tell mockito to reset the mock to the beginning for each test
        reset(beerService);
    }
    ...
    void testGetBeerById() throws Exception {
        ...
        MvcResult result = mockMvc.perform(get("/api/v1/beer/" + validBeer.getId()))
                ...
                .andExpect(jsonPath(
                        // we need to setUp jackson to behave properly because this expects date format
                        // and just gives the components of the date...
                        "$.createdDate", is(dateTimeFormatter.format(validBeer.getCreatedDate()))
                ))
                .andReturn();
...
//    /**
//     * Function to change the behaviour of jackson, so it handles date objects in date format instead of
//     * date components
//     */
